...
void Storage::remove_stock()
{
    ...
    cout << "\n\n * To Search for an Item by ID, Press 'N' for NO or";
    cout << "\n * Enter 'Y' for YES or 'X' to EXIT to Menu: ";
    cin >> rmv_response;
...
void Storage::edit_stock()
{
    ...
    cout << "\nPress 'Y' for Yes or 'X' to Exit to Menu." << "\n\n>";
    cin >> stay_go;
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    stay_go = toupper(stay_go);     

    if (stay_go != 'Y' && stay_go != 'X')
    {
        cout << "\nINVALID. Please enter Only 'X' to EXIT or 'Y' for YES to Edit.";
        cout << "\nTry Again.";
        cout << "\n\nPlease choose an option (A, D, E, P, or Q to Quit): ";
        return;
    }
    ...
    while ( anID < 10000 || anID > 99999)
    {
        cout << "\nINVALID ENTRY. All IDs Are 5 Digits (10000-99999).";
        cin.clear();                    // Clear Error Message
        cin.ignore(numeric_limits<streamsize>::max(), '\n');
    ...
    cout << "\nUpdate the Entry for This Item:";
    cout << "\nPlease Press <Enter> after each item category.\n";
...
int main()
{
    ...
    if (menu_option == 'Q')
        {
            cout << "\n♥ Love is Boundless AND Priceless at StockMates ♥\n" << endl;
            cout << "Goodbye!";
        }
